...
@Component({
  ...
  standalone: true,
  imports: [MatButtonModule, RouterLink, MatFormFieldModule, MatInputModule, MatDatepickerModule, ReactiveFormsModule, InputImgComponent],
